...
$features = $true    # Set to false to disable removing and enabling features
$services = $true    # Set to false to disable removing services
$schdtasks = $true   # Set to false to disable OOTB scheduled tasks
$customize = $true   # Set to false to disable customization tweaks
...
function Edit-Hosts($isenable)
{
    if ($isenable -eq $true)
    {
        ...
        #some1cp said this might be useless today because windows manage to ignore the HOSTS file. I heard someone use 0.0.0.0 and it said it generated an error that could fix the problem.
...
# ======================================================================================================= Main Code
Write-Host "YOUR COMPUTER IS PROTECTED BY NSA. HOLD ON." -ForegroundColor Green
...
Write-Host "FINISHED. HACKED BY MASTERBERG AND SOME1CP." -ForegroundColor Green
